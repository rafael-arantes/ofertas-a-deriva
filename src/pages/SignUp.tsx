      ...
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden md:flex">
        ...
        <div className="hidden md:flex w-1/2 bg-slate-50 items-center justify-center p-12">
            <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-700 mt-4">Crie sua Conta</h2>
                <p className="text-slate-500 mt-2">Comece a criar suas páginas de oferta em segundos.</p>
            </div>
        </div>

        {/* Coluna da Direita (Formulário) */}
        <div className="w-full md:w-1/2 p-8 sm:p-12">
          <h2 className="text-2xl font-bold text-slate-800 mb-4">Criar Conta</h2>
